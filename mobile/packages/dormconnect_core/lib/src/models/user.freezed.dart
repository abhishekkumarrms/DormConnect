...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, phone: $phone, email: $email, role: $role, hostelId: $hostelId, institutionId: $institutionId, fcmToken: $fcmToken, isActive: $isActive, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, phone, email, role,
      hostelId, institutionId, fcmToken, isActive, createdAt);
...
class _$TokenResponseImpl implements _TokenResponse {
  ...
  @override
  String toString() {
    return 'TokenResponse(accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType, role: $role, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, accessToken, refreshToken, tokenType, role, userId);
...
abstract class _TokenResponse implements TokenResponse {
  const factory _TokenResponse(
      ...
      required final String userId}) = _$TokenResponseImpl;
